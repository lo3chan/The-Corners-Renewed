...
public class CornerBlocks {
    ...
    public static final DeferredItem<Item> THE_SWARMER_SPAWN_EGG = ITEMS.register("the_swarmer_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_SWARMER, 0x2b271d, 0x8a6231, new Item.Properties()));
    public static final DeferredItem<Item> THE_LURKER_SPAWN_EGG = ITEMS.register("the_lurker_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_LURKER, 0x1f2b1d, 0x3a5a31, new Item.Properties()));
    public static final DeferredItem<Item> THE_HEAVY_SPAWN_EGG = ITEMS.register("the_heavy_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_HEAVY, 0x383838, 0x1a1a1a, new Item.Properties()));
    public static final DeferredItem<Item> THE_SPITTER_SPAWN_EGG = ITEMS.register("the_spitter_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_SPITTER, 0x2d3a24, 0x5c7a4b, new Item.Properties()));
    public static final DeferredItem<Item> THE_SPECTRE_SPAWN_EGG = ITEMS.register("the_spectre_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_SPECTRE, 0x4a607a, 0x8ab4e0, new Item.Properties()));
    public static final DeferredItem<Item> THE_HUNTER_SPAWN_EGG = ITEMS.register("the_hunter_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_HUNTER, 0x242424, 0xa83232, new Item.Properties()));
    public static final DeferredItem<Item> THE_HORRORS_SPAWN_EGG = ITEMS.register("the_horrors_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_HORRORS, 0x181818, 0x6e1b1b, new Item.Properties()));
    public static final DeferredItem<Item> THE_UNDEAD_WOLF_SPAWN_EGG = ITEMS.register("the_undead_wolf_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_UNDEAD_WOLF, 0x3b3a36, 0x822929, new Item.Properties()));
    public static final DeferredItem<Item> THE_ROD_SPAWN_EGG = ITEMS.register("the_rod_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_ROD, 0x2c2621, 0xbf8547, new Item.Properties()));
    public static final DeferredItem<Item> THE_CLOGGER_SPAWN_EGG = ITEMS.register("the_clogger_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_CLOGGER, 0x382d24, 0x1e1713, new Item.Properties()));
    public static final DeferredItem<Item> THE_PREGNANT_SPAWN_EGG = ITEMS.register("the_pregnant_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_PREGNANT, 0x3a3028, 0x8f4c4c, new Item.Properties()));
    public static final DeferredItem<Item> THE_WHEEZER_SPAWN_EGG = ITEMS.register("the_wheezer_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_WHEEZER, 0x2a363b, 0x7a999e, new Item.Properties()));
    public static final DeferredItem<Item> THE_LUMBER_SPAWN_EGG = ITEMS.register("the_lumber_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_LUMBER, 0x3b2d1f, 0x6e4e2f, new Item.Properties()));
    public static final DeferredItem<Item> THE_SUCKER_SPAWN_EGG = ITEMS.register("the_sucker_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_SUCKER, 0x1b2b2b, 0x4a7a7a, new Item.Properties()));
    public static final DeferredItem<Item> THE_BIG_SUCKER_SPAWN_EGG = ITEMS.register("the_big_sucker_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_BIG_SUCKER, 0x142020, 0x6a9e9e, new Item.Properties()));
    public static final DeferredItem<Item> THE_FIRE_DUST_SPAWN_EGG = ITEMS.register("the_fire_dust_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_FIRE_DUST, 0x401810, 0xd4652f, new Item.Properties()));
    public static final DeferredItem<Item> DEAD_CLOGGER_SPAWN_EGG = ITEMS.register("dead_clogger_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.DEAD_CLOGGER, 0x2a241f, 0x151210, new Item.Properties()));
    public static final DeferredItem<Item> SLAVEMAN_SPAWN_EGG = ITEMS.register("slaveman_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.SLAVEMAN, 0x303030, 0x606060, new Item.Properties()));
    public static final DeferredItem<Item> THE_MOONFLOWER_SPAWN_EGG = ITEMS.register("the_moonflower_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_MOONFLOWER, 0x1c2b36, 0x5bb0d6, new Item.Properties()));
    public static final DeferredItem<Item> THE_BEARTAMER_SPAWN_EGG = ITEMS.register("the_beartamer_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_BEARTAMER, 0x2b2017, 0x523d2b, new Item.Properties()));
    public static final DeferredItem<Item> THE_BIDY_SPAWN_EGG = ITEMS.register("the_bidy_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_BIDY, 0x262626, 0x737373, new Item.Properties()));
    public static final DeferredItem<Item> THE_BIDY_UPSIDE_SPAWN_EGG = ITEMS.register("the_bidy_upside_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_BIDY_UPSIDE, 0x202020, 0x505050, new Item.Properties()));
    public static final DeferredItem<Item> THE_DUNGEON_SPAWN_EGG = ITEMS.register("the_dungeon_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_DUNGEON, 0x1f1d1a, 0x4d4740, new Item.Properties()));
    public static final DeferredItem<Item> THE_GLITER_SPAWN_EGG = ITEMS.register("the_gliter_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_GLITER, 0x3a3420, 0xcca833, new Item.Properties()));
    public static final DeferredItem<Item> THE_IMMORTAL_SPAWN_EGG = ITEMS.register("the_immortal_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_IMMORTAL, 0x1a1a24, 0x4b4b80, new Item.Properties()));
    public static final DeferredItem<Item> THE_ORDURE_SPAWN_EGG = ITEMS.register("the_ordure_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_ORDURE, 0x292119, 0x4d3c2c, new Item.Properties()));
    public static final DeferredItem<Item> THE_POSESSIVE_SPAWN_EGG = ITEMS.register("the_posessive_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_POSESSIVE, 0x241829, 0x6c3d82, new Item.Properties()));
    public static final DeferredItem<Item> THE_RABIDUS_SPAWN_EGG = ITEMS.register("the_rabidus_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_RABIDUS, 0x2b1c1c, 0x872929, new Item.Properties()));
    public static final DeferredItem<Item> THE_SKEEPER_SPAWN_EGG = ITEMS.register("the_skeeper_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_SKEEPER, 0x2e2b27, 0x6b6359, new Item.Properties()));
    public static final DeferredItem<Item> THE_SMOKER_SPAWN_EGG = ITEMS.register("the_smoker_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_SMOKER, 0x242424, 0x4a4a4a, new Item.Properties()));
    public static final DeferredItem<Item> THE_SOMNOLENCE_SPAWN_EGG = ITEMS.register("the_somnolence_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.THE_SOMNOLENCE, 0x1c202b, 0x3b4c73, new Item.Properties()));
    public static final DeferredItem<Item> RESTLESS_SPIRIT_SPAWN_EGG = ITEMS.register("restless_spirit_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.RESTLESS_SPIRIT, 0x24333d, 0x608ea6, new Item.Properties()));
    public static final DeferredItem<Item> DECREPIT_SKELETON_SPAWN_EGG = ITEMS.register("decrepit_skeleton_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.DECREPIT_SKELETON, 0x3d3c38, 0x807c74, new Item.Properties()));
    public static final DeferredItem<Item> DECAYING_ZOMBIE_SPAWN_EGG = ITEMS.register("decaying_zombie_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.DECAYING_ZOMBIE, 0x283b27, 0x547551, new Item.Properties()));
    public static final DeferredItem<Item> SKELETON_DEMOMAN_SPAWN_EGG = ITEMS.register("skeleton_demoman_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.SKELETON_DEMOMAN, 0x3b3a36, 0x9e382b, new Item.Properties()));
    public static final DeferredItem<Item> SKELETON_THRASHER_SPAWN_EGG = ITEMS.register("skeleton_thrasher_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.SKELETON_THRASHER, 0x3b3a36, 0x6b1d1d, new Item.Properties()));
    public static final DeferredItem<Item> DARK_VORTEX_SPAWN_EGG = ITEMS.register("dark_vortex_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.DARK_VORTEX, 0x14121a, 0x3f385c, new Item.Properties()));
    public static final DeferredItem<Item> BONE_IMP_SPAWN_EGG = ITEMS.register("bone_imp_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.BONE_IMP, 0x4a463d, 0xa19885, new Item.Properties()));
    public static final DeferredItem<Item> NIGHTMARE_STALKER_SPAWN_EGG = ITEMS.register("nightmare_stalker_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.NIGHTMARE_STALKER, 0x121217, 0x4a1b54, new Item.Properties()));
    public static final DeferredItem<Item> FALLEN_CHAOS_KNIGHT_SPAWN_EGG = ITEMS.register("fallen_chaos_knight_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.FALLEN_CHAOS_KNIGHT, 0x1f2129, 0x7a3030, new Item.Properties()));
    public static final DeferredItem<Item> MISSIONER_SPAWN_EGG = ITEMS.register("missioner_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.MISSIONER, 0x262422, 0x786f68, new Item.Properties()));
    public static final DeferredItem<Item> SEARED_SPIRIT_SPAWN_EGG = ITEMS.register("seared_spirit_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.SEARED_SPIRIT, 0x402316, 0xbf5b28, new Item.Properties()));
    public static final DeferredItem<Item> PHANTOM_CREEPER_SPAWN_EGG = ITEMS.register("phantom_creeper_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.PHANTOM_CREEPER, 0x1a2e24, 0x367a5c, new Item.Properties()));
    public static final DeferredItem<Item> CORPSE_FISH_SPAWN_EGG = ITEMS.register("corpse_fish_spawn_egg", () -> new net.neoforged.neoforge.common.DeferredSpawnEggItem(CornerEntities.CORPSE_FISH, 0x2b332b, 0x597359, new Item.Properties()));
    ...
    public static final Supplier<CreativeModeTab> CORNERS_TAB = CREATIVE_MODE_TABS.register("corners_tab", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(THE_SWARMER_SPAWN_EGG.get());
                output.accept(THE_LURKER_SPAWN_EGG.get());
                output.accept(THE_HEAVY_SPAWN_EGG.get());
                output.accept(THE_SPITTER_SPAWN_EGG.get());
                output.accept(THE_SPECTRE_SPAWN_EGG.get());
                output.accept(THE_HUNTER_SPAWN_EGG.get());
                output.accept(THE_HORRORS_SPAWN_EGG.get());
                output.accept(THE_UNDEAD_WOLF_SPAWN_EGG.get());
                output.accept(THE_ROD_SPAWN_EGG.get());
                output.accept(THE_CLOGGER_SPAWN_EGG.get());
                output.accept(THE_PREGNANT_SPAWN_EGG.get());
                output.accept(THE_WHEEZER_SPAWN_EGG.get());
                output.accept(THE_LUMBER_SPAWN_EGG.get());
                output.accept(THE_SUCKER_SPAWN_EGG.get());
                output.accept(THE_BIG_SUCKER_SPAWN_EGG.get());
                output.accept(THE_FIRE_DUST_SPAWN_EGG.get());
                output.accept(DEAD_CLOGGER_SPAWN_EGG.get());
                output.accept(SLAVEMAN_SPAWN_EGG.get());
                output.accept(THE_MOONFLOWER_SPAWN_EGG.get());
                output.accept(THE_BEARTAMER_SPAWN_EGG.get());
                output.accept(THE_BIDY_SPAWN_EGG.get());
                output.accept(THE_BIDY_UPSIDE_SPAWN_EGG.get());
                output.accept(THE_DUNGEON_SPAWN_EGG.get());
                output.accept(THE_GLITER_SPAWN_EGG.get());
                output.accept(THE_IMMORTAL_SPAWN_EGG.get());
                output.accept(THE_ORDURE_SPAWN_EGG.get());
                output.accept(THE_POSESSIVE_SPAWN_EGG.get());
                output.accept(THE_RABIDUS_SPAWN_EGG.get());
                output.accept(THE_SKEEPER_SPAWN_EGG.get());
                output.accept(THE_SMOKER_SPAWN_EGG.get());
                output.accept(THE_SOMNOLENCE_SPAWN_EGG.get());
                output.accept(RESTLESS_SPIRIT_SPAWN_EGG.get());
                output.accept(DECREPIT_SKELETON_SPAWN_EGG.get());
                output.accept(DECAYING_ZOMBIE_SPAWN_EGG.get());
                output.accept(SKELETON_DEMOMAN_SPAWN_EGG.get());
                output.accept(SKELETON_THRASHER_SPAWN_EGG.get());
                output.accept(DARK_VORTEX_SPAWN_EGG.get());
                output.accept(BONE_IMP_SPAWN_EGG.get());
                output.accept(NIGHTMARE_STALKER_SPAWN_EGG.get());
                output.accept(FALLEN_CHAOS_KNIGHT_SPAWN_EGG.get());
                output.accept(MISSIONER_SPAWN_EGG.get());
                output.accept(SEARED_SPIRIT_SPAWN_EGG.get());
                output.accept(PHANTOM_CREEPER_SPAWN_EGG.get());
                output.accept(CORPSE_FISH_SPAWN_EGG.get());
    ...
    public static void buildContents(BuildCreativeModeTabContentsEvent event) {
        ...
        if (event.getTabKey() == CreativeModeTabs.SPAWN_EGGS) {
            event.accept(THE_SWARMER_SPAWN_EGG);
            event.accept(THE_LURKER_SPAWN_EGG);
            event.accept(THE_HEAVY_SPAWN_EGG);
            event.accept(THE_SPITTER_SPAWN_EGG);
            event.accept(THE_SPECTRE_SPAWN_EGG);
            event.accept(THE_HUNTER_SPAWN_EGG);
            event.accept(THE_HORRORS_SPAWN_EGG);
            event.accept(THE_UNDEAD_WOLF_SPAWN_EGG);
            event.accept(THE_ROD_SPAWN_EGG);
            event.accept(THE_CLOGGER_SPAWN_EGG);
            event.accept(THE_PREGNANT_SPAWN_EGG);
            event.accept(THE_WHEEZER_SPAWN_EGG);
            event.accept(THE_LUMBER_SPAWN_EGG);
            event.accept(THE_SUCKER_SPAWN_EGG);
            event.accept(THE_BIG_SUCKER_SPAWN_EGG);
            event.accept(THE_FIRE_DUST_SPAWN_EGG);
            event.accept(DEAD_CLOGGER_SPAWN_EGG);
            event.accept(SLAVEMAN_SPAWN_EGG);
            event.accept(THE_MOONFLOWER_SPAWN_EGG);
            event.accept(THE_BEARTAMER_SPAWN_EGG);
            event.accept(THE_BIDY_SPAWN_EGG);
            event.accept(THE_BIDY_UPSIDE_SPAWN_EGG);
            event.accept(THE_DUNGEON_SPAWN_EGG);
            event.accept(THE_GLITER_SPAWN_EGG);
            event.accept(THE_IMMORTAL_SPAWN_EGG);
            event.accept(THE_ORDURE_SPAWN_EGG);
            event.accept(THE_POSESSIVE_SPAWN_EGG);
            event.accept(THE_RABIDUS_SPAWN_EGG);
            event.accept(THE_SKEEPER_SPAWN_EGG);
            event.accept(THE_SMOKER_SPAWN_EGG);
            event.accept(THE_SOMNOLENCE_SPAWN_EGG);
            event.accept(RESTLESS_SPIRIT_SPAWN_EGG);
            event.accept(DECREPIT_SKELETON_SPAWN_EGG);
            event.accept(DECAYING_ZOMBIE_SPAWN_EGG);
            event.accept(SKELETON_DEMOMAN_SPAWN_EGG);
            event.accept(SKELETON_THRASHER_SPAWN_EGG);
            event.accept(DARK_VORTEX_SPAWN_EGG);
            event.accept(BONE_IMP_SPAWN_EGG);
            event.accept(NIGHTMARE_STALKER_SPAWN_EGG);
            event.accept(FALLEN_CHAOS_KNIGHT_SPAWN_EGG);
            event.accept(MISSIONER_SPAWN_EGG);
            event.accept(SEARED_SPIRIT_SPAWN_EGG);
            event.accept(PHANTOM_CREEPER_SPAWN_EGG);
            event.accept(CORPSE_FISH_SPAWN_EGG);
